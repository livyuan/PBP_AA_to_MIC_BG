...
PBP_AA_TO_MIC2<- function(cwd){
  ...
  colAA=5:918
  m1=read.csv("train_PT_AA_table.csv", colClasses="character") 
  n1=dim(m1)[1] 
  ...
  m4=read.csv("Ref_PBPtype_MIC.csv", colClasses="character") 
  ...
  ## Re-level predictors
  m1=read.csv("NR_Varsites_Randomforest.csv", colClasses="character") 
  colAA=colnames(m1)
