...
sp= ggplot(df2, aes(x=DRUG, y=AUC, fill = Method)) +   
  ...
  geom_errorbar(data=df2, aes(ymin=LCL, ymax=UCL), 
      width=0.2, size=1, color="black", position=position_dodge(.9)) 
sp=sp+scale_y_continuous(breaks=c(0, 1, 2, 3, 5, 10), limit=c(0, 10), expand = c(0, 0))
...
sp3=sp3+theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), 
	...
	axis.title.x=element_text(size=14,face="bold"),
	axis.title.y=element_text(size=14,face="bold"))+
	annotate("text", x = 1:6, y = 4, label = m4[2*(1:6),10], size=5)
...
sp=sp+scale_y_continuous(breaks=c(1.5, 7.5, 20, 40, 60, 80, 100), limit=c(0, 100), expand = c(0, 0))
...
sp3=sp3+theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), 
	...
	axis.title.x=element_text(size=14,face="bold"),
	axis.title.y=element_text(size=14,face="bold"))+
	annotate("text", x = 1:6, y = 70, label = m4[2*(1:6),7], size=5)
